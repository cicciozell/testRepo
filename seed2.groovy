...
def jobs = new BufferedReader(new InputStreamReader(new FileInputStream( "/var/lib/jenkins/workspace/dslSeedWithJobGitJson/seed2.json"),"UTF-8"))
    ...
    steps {
        downstreamParameterized {
            trigger('testDownstreamWith2Params') {
                ...
                parameters {
                    predefinedProp('downstreamFirstParam', '$Name')
                    predefinedProp('downstreamSecondParam', '$Age')
               }
            }
        }
      }
